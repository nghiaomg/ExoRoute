...
//!
//! The HTTP/authentication lifecycle stays in [`super::usage`]. This module
//! owns only the provider response shape, normalization, and the bounded
//! quota projection used by the dashboard.

use serde_json::{Value, json};

pub(crate) const MAX_USAGE_QUOTAS: usize = 128;

pub(in crate::provider_adapters::auth::codex) fn unix_now() -> i64 {
